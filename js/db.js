...
const DEFAULT_DATABASE = {
    ...
    /*
     * Évènements ponctuels de l'emploi du temps,
     * ajoutés à une date précise (pas récurrents,
     * contrairement aux scheduleBlocks de la
     * semaine type).
     */
...
function getPunctualEvents() {

    const database =
        loadDatabase();


    return database.punctualEvents;

}


function getPunctualEventsForDate(
    dateKey
) {

    return getPunctualEvents()
        .filter(
            event =>
                event.date === dateKey
        )
...
function getPunctualEvent(
    ...
    return database.punctualEvents.find(
...
function updatePunctualEvent(
    ...
    const eventIndex =
        database.punctualEvents.findIndex(
...
function deletePunctualEvent(
    ...
    database.punctualEvents =
        database.punctualEvents.filter(
