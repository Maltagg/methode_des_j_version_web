...
function handleClick(event) {
    ...
    switch (action) {
        ...
        case "add-punctual-event":

            openPunctualEventForm(
                null,
                target.dataset.date
            );
        ...
        case "delete-punctual-event":

            deletePunctualEventFromUI(
                target.dataset.id
            );
                    ...
                    <div class="discovery-step">
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                voir son détail, et utilise
                                « + Ajouter un évènement » pour
                                caser un truc ponctuel (un rendez-vous,
                                un imprévu...) directement à une date
                                et une heure précises.
                            </p>
...
const TOUR_STEPS = [
...

    {
        ...
        text:
            ...
            "ta semaine type. Tu peux aussi y ajouter des " +
            "évènements ponctuels, à une date et une heure " +
            "précises, comme sur un agenda classique."
    },
...
function renderPlanning() {
    ...
    const dayEvents =
        Database.getPunctualEventsForDate(
            dateKey
        );
    ...
    const dayItems =
        ...
        .sort(
            (a, b) =>
                a.item.startTime.localeCompare(
                    b.item.startTime
                )
        );
            ...
            <section class="agenda-day">
                ...
                <div class="planning-day-header">
                    ...
                    <button
                        type="button"
                        class="secondary-button"
                        data-action="add-punctual-event"
                        data-date="${escapeAttribute(dateKey)}"
                    >
                ...
                ${
                    dayItems.length === 0
                        ...
                        ? renderEmptyState(
                            "🗓️",
                            "Rien de prévu",
                            "Aucun créneau ni évènement ce jour-là."
                        )
...
function renderPunctualEventItem(
    event
) {
    ...
    return `
        ...
        <div
            class="schedule-block planning-block punctual-event-item"
            style="--domain-color:${escapeAttribute(color)};"
        >
            ...
            <div class="schedule-block-actions">
                ...
                <button
                    type="button"
                    data-action="edit-punctual-event"
                    data-id="${escapeAttribute(event.id)}"
                    title="Modifier"
                >
                    ✏️
                </button>
                ...
                <button
                    type="button"
                    data-action="delete-punctual-event"
                    data-id="${escapeAttribute(event.id)}"
                    title="Supprimer"
                >
                    ✕
...
/* ======================================================
   FORMULAIRE ÉVÈNEMENT PONCTUEL (EMPLOI DU TEMPS)
   ====================================================== */

function openPunctualEventForm(
    event = null,
    presetDate = null
) {

    AppState.editingPunctualEventId =
        event
            ? event.id
            : null;
            ...
            >
                ...
                <label>
                    ...
                    <input
                        type="date"
                        name="date"
                        value="${escapeAttribute(defaultDate)}"
                        required
                    >
                ...
                <div style="display:flex; gap:12px;">
                    ...
                    <label style="flex:1;">
                        ...
                        <input
                            ...
                            value="${
                                event
                                    ? escapeAttribute(event.startTime)
                                    : "08:00"
                            }"
                            required
                        >
                                ...
                                .map(
                                    domainOption => `
                                        <option
                                            ...
                                            ${
                                                event &&
                                                event.domainId === domainOption.id
                                                    ? "selected"
                                                    : ""
                                            }
                                        >
...
function savePunctualEventFromForm(
    form
) {
...
function editPunctualEvent(
    eventId
) {

    const event =
        Database.getPunctualEvent(
            eventId
        );
...
function deletePunctualEventFromUI(
    eventId
) {
